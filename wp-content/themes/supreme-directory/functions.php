...
function sd_footer_copyright_default() {
    ...
    if ($dt_disable_footer_credits != '1') {
        $theme_name = "COVID-19 ванредно ";
        $theme_url = "https://covid19.rs/";

        $wp_link = '<a href="https://wordpress.org/" target="_blank" title="' . esc_attr__('WordPress', 'supreme-directory') . '"><span>' . __('група ентузијаста', 'supreme-directory') . '</span></a>';
        $default_footer_value = sprintf(__('Copyright &copy; %1$s %2$s %3$s стање %4$s', 'supreme-directory'),date('Y'),"<a href='$theme_url' target='_blank' title='$theme_name'>", $theme_name, "</a>");
        $default_footer_value .= sprintf(__(' - Израђује и податке обрађује %s.', 'supreme-directory'), $wp_link);
